<!-- resources/views/components/guest/header.blade.php -->
<header class="relative z-10">
    <div class="container mx-auto px-4">
        <!-- Floating Navigation Bar -->
        <nav class="mt-4 bg-white rounded-full shadow-lg border border-gray-100">
            <div class="px-6 py-3">
                <div class="flex items-center justify-between">
                    <!-- Logo -->
                    <div class="flex items-center">
                        <a href="{{ route('home') }}" class="flex items-center space-x-3">
                            <img src="{{ asset('favicon.png') }}" alt="Logo" class="h-10 w-auto">
                            <span class="text-xl font-bold text-blue-600">Armada Jaya Transport</span>
                        </a>
                    </div>
                ...
                <div class="hidden md:hidden mt-4 pb-3">
